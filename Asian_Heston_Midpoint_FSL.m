%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% File: Asian_Heston_Midpoint_FSL.m
%
% Purpose: Monte Carlo simulation of the Heston model by a Midpoint Full
% Stochastic Lawson scheme to price Asian Options
%
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [S, arithmetic_price , geometric_price , arithmetic_std,geometric_std , elapsed_time] = Asian_Heston_Midpoint_FSL(S0 ,r,V0 ,K,T,type ,kappa ,theta ,sigma ,rho ,Nt ,Nsim ,R)
tic
...
[~,S ,~] = MidpointFSLVectorized (X0 ,A,g0 ,B,g,tspan ,h,dW ,g0Jac ,gJac ,Bexp); 
