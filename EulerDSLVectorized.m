...
% Euler -Maruyame DSL scheme of strong order 0.5 and weak order
% to approximate the solution of
% dX=[AX+g_0(X)]dt + sum_{m=1}^Mg{m}(X)dW{m} on the time
% interval tspan with step
% size h, Wiener increments dW of dimension [n-1,P] where n-1
% is the number
% of time steps and P the number of paths to simulate , and
% initial value X0.
