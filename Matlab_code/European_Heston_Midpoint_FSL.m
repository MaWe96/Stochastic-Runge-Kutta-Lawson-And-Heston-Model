...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [type , option_price , std_deviation , elapsed_time ] = European_Heston_Midpoint_FSL (S0 ,r,V0 ,K,T,type ,kappa ,theta ,sigma ,rho ,Nt ,Nsim ,h,R)
% set random number generator seed for reproducibility
rng('default');
tic
% prepare input parameters to call Matlab funxction
...
% calculate the price of the option and time used
