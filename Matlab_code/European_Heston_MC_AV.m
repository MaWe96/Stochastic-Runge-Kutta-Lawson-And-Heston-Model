...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [type , option_price , std_deviation , elapsed_time ] = European_Heston_MC_AV (S0 ,r,V0 ,K,type ,kappa ,theta ,sigma ,rho ,Nt ,Nsim ,h,R)
...
% calculate option price average and time used
