...
% Full Stochastic Lawson scheme with Control Variate
% variance reduction technique to price European
% Options
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [type , option_price , std_deviation , elapsed_time ] = European_Heston_Midpoint_FSL_CV (S0 ,r,V0 ,K,K_cv ,T,type ,kappa,theta ,sigma ,rho ,Nt ,Nsim ,h,R)
...
% calculate g1 and g2 and Jacobians
...
C = cov(payoff , CV);
b = C(1 ,2)/v;
% calcualte the option price and time taken
